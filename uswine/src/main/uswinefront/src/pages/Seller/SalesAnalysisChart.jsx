    ...
    if (chartCheck != 4) {
      AuthApi("/api/seller/chart/price", {
        ...
        const sortKeys = Object.keys(data).sort(
          (a, b) =>
            new Date(a.replace(" KST", "")).getTime() -
            new Date(b.replace(" KST", "")).getTime()
        );
        let newlabel = [];
        let newdata = [];
  ...
  let wine = {
    ...
    datasets: [
      ...
      },
      {
        label: "MD 와인",
        data:
          stockAndCount === 0 ? wineInfoChartStockData : wineInfoChartCountData, //실제 그려지는 데이터(Y축 숫자)
  ...
  return (
    <div className="seller_sales_analysis_container">
      <div className="sales_analysis_container">
        <div className="sales_analysis_stick_graph"></div>
      </div>
      {/* 와인 그래프 */}
      <div className="sales_analysis_container">
        <p style={{ color: "#888", fontSize: "15px" }}>
          사용자 설정을 제외한 나머지 항목은 오늘 날을 기준으로 그래프를
          보여줍니다.( 5년, 12개월 )
        </p>
        <div className="sales_analysis_sell_line_graph">
          <div className="sales_analysis_info_wine_graph">
            ...
            <div className="sales_analysis_line_graph">
              <Line
                className="sales_analysis_line_sub_chart"
                options={wineoptions}
                data={wine}
              />
            </div>
          ...
          <div className="sales_analysis_sell_wine_graph">
            ...
            <div className="wine_graph_setting_btn_container">
              <div className="wine_graph_setting_btn">
                <button
                  className={
                    wineTransactionCheck === 0 ? "chartbtnClick" : null
                  }
                ...
                <button
                  className={
                    wineTransactionCheck === 1 ? "chartbtnClick" : null
                  }
      ...
      <div className="sales_analysis_container">
        <div className="sales_analysis_line_graph_container">
          ...
          <div className="sales_analysis_line_graph">
            <Line
              className="sales_analysis_line_chart"
              options={options}
              data={data}
            />
          </div>
